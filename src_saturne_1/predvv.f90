...
double precision, dimension(:), pointer :: cvara_pr, cvara_k,cvar_pr
...
print*,"pressure(50)", cvar_pr(50)
print*,"grad pressure(50)", grad(1,50),grad(2,50),grad(3,50)
...
print*,pcrom(50),"pcrom in fimp in predvv"
  do iel = 1, ncel
    do isou = 1, 3
...
print*,'c_st_vel, predvv after',c_st_vel(1,50)
!-------------------------------------------------------------------------------
! --->  Mass source terms
