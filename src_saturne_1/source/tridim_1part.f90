...
integer          isvhb, iz
integer          ii
integer          iterns, inslst, icvrge, iter_sca, nter_sca
...
print*,"=======================interns, iter_sca==========================",iterns, iter_sca
!========================================================================
...
!===============================================================================
  ...
  do iel = 1, ncel
    do ii = 1, 3
      c_st_vela(ii,iel) = c_st_vel(ii,iel)
    enddo
  enddo 
