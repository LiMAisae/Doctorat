...
call field_get_val_s(iflmas, imasfl)
 print*,'i_mass_flux',imasfl(50),' begining in navstv, before predvv'
...
print*, "vel, vela",vel(1,50),vela(1,50), "before predvv"
!print*,'crom', crom(50),"before predvv"
...
( iappel ,                                                       &
  ...
  w1     , w7     , w8     , w9     )
print*, "vel, vela",vel(1,50),vela(1,50), "after predvv"
!print*,'crom', crom(50),"after predvv"
...
( nvar   , ncetsm , nfbpcd , ncmast ,                            &
 ...
 print*,'i_mass_flux',imasfl(50),' begining in navstv, after resopv'
print*, "vel, vela",vel(1,50),vela(1,50), "after resopv"
!===============================================================================
...
!print*, "vel, vela",vel(1,50),vela(1,50), "after update"
